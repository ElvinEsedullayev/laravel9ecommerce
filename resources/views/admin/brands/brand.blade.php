...
<div class="card-body">
  <a href="{{url('admin/brand-add-edit')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Yeni</a><br><br>
...
<td>
 <a href="{{url('admin/brand-add-edit/'.$brand['id'])}}">
 ...
 {{-- <a href="{{url('admin/section-delete/'.$section['id'])}}" title="section" class="confirmDelete">
  ...
  {{-- sweet alert2 javascript --}}
   <a href="Javascript:void(0)" module="brand" moduleid="{{$brand['id']}}" class="confirmDelete">
  <i class="fa fa-trash fa-lg"></i>
</a>
{{-- sweet alert2 javascript --}}
</td>
